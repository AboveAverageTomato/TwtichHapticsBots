...
class Bot(commands.Bot):
    def __init__(self):
        ...
        super().__init__(irc_token=irc_token,
                         client_id=client_id,
                         nick=channel_name,
                         prefix='!',  # This is what defines the beginning of a command i.e !poke @poke ?poke etc
...
if __name__ == "__main__":
    ...
    try:
        # Init Haptics player:
        print("Initializing Haptics Player...")
        bhaps_player = HapticPlayer()
        if bhaps_player:
            bhaps_register_all()
    except Exception as e:
        print(f"HAPTICS ERROR!\n{e}")
...
# Feature Requests:
#   + If haptics player is down, disable haptic command recognition
#       - Twitch chat has auto same msg cool down, but can be bypassed!
#   + New Commands:
#       - Gut Punch
#       - Graze
#       - Night's Caress (TM)
#       - Odysseus: NightRider Pattern
#       + Fondle??
#           - Side Squeeze?
#   + User Haptics/Chat recognition?
